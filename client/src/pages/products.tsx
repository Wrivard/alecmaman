    ...
    <div className="min-h-screen bg-background font-sans text-foreground">
      ...
      <main>
        ...
        <section className="bg-primary/5 py-16 text-center">
          <div className="container mx-auto px-6">
            <Droplet className="w-8 h-8 text-primary mx-auto mb-4 opacity-50" />
            <p className="font-serif text-2xl text-foreground mb-2">Besoin de conseils pour choisir ?</p>
            <p className="text-muted-foreground mb-6">Chaque peau est unique. Écrivez-nous pour trouver le savon parfait pour vous.</p>
            <Link href="/contact">
              <a className="text-sm font-bold uppercase tracking-widest text-primary hover:text-foreground border-b border-primary/30 pb-1 hover:border-foreground transition-all">
                Demander conseil
              </a>
            </Link>
          </div>
